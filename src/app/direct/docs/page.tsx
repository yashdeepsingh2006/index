...
export default function DocumentationPage(): React.JSX.Element {
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#f9f9ec] to-[#eff0d7] py-4 sm:py-6 lg:py-8 cursor-default">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8 sm:mb-12 lg:mb-16">
          ...
          <p className="text-base sm:text-lg lg:text-xl text-[#596229] max-w-4xl mx-auto leading-relaxed px-4">
            Your simple solution for turning business data into beautiful, easy-to-understand charts and reports!
          </p>
        </div>

        {/* Table of Contents */}
        <div className="bg-white rounded-xl shadow-lg border border-[#cfd592] p-4 sm:p-6 lg:p-8 mb-6 sm:mb-8">
          <h2 className="text-xl sm:text-2xl lg:text-3xl font-semibold text-[#494f25] mb-4 sm:mb-6">Table of Contents</h2>
          <ol className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3 text-sm sm:text-base text-[#494f25]">
            <li className="p-2 hover:bg-[#f9f9ec] rounded-lg transition-colors"><a href="#getting-started" className="hover:underline">1. Getting Started</a></li>
            <li className="p-2 hover:bg-[#f9f9ec] rounded-lg transition-colors"><a href="#uploading-data" className="hover:underline">2. Uploading Your Data</a></li>
            <li className="p-2 hover:bg-[#f9f9ec] rounded-lg transition-colors"><a href="#viewing-data" className="hover:underline">3. Viewing Your Data</a></li>
            <li className="p-2 hover:bg-[#f9f9ec] rounded-lg transition-colors"><a href="#creating-charts" className="hover:underline">4. Creating Charts and Graphs</a></li>
            <li className="p-2 hover:bg-[#f9f9ec] rounded-lg transition-colors"><a href="#understanding-reports" className="hover:underline">5. Understanding Your Reports</a></li>
            <li className="p-2 hover:bg-[#f9f9ec] rounded-lg transition-colors"><a href="#tips-best-practices" className="hover:underline">6. Tips and Best Practices</a></li>
            <li className="p-2 hover:bg-[#f9f9ec] rounded-lg transition-colors"><a href="#troubleshooting" className="hover:underline">7. Troubleshooting</a></li>
            <li className="p-2 hover:bg-[#f9f9ec] rounded-lg transition-colors"><a href="#getting-help" className="hover:underline">8. Getting Help</a></li>
          </ol>
        </div>

        {/* Getting Started Section */}
        <section id="getting-started" className="bg-white rounded-xl shadow-lg border border-[#cfd592] p-4 sm:p-6 lg:p-8 mb-6 sm:mb-8">
          <h2 className="text-xl sm:text-2xl lg:text-3xl font-semibold text-[#494f25] mb-4 sm:mb-6">Getting Started</h2>
          
          <div className="mb-4 sm:mb-6">
            <h3 className="text-lg sm:text-xl font-semibold text-[#596229] mb-2 sm:mb-3">What You&apos;ll Need</h3>
            <ul className="list-disc list-inside space-y-1 sm:space-y-2 text-sm sm:text-base text-gray-700 pl-2">
          ...
          <div className="mb-4 sm:mb-6">
            <h3 className="text-lg sm:text-xl font-semibold text-[#596229] mb-2 sm:mb-3">First Time Setup</h3>
        ...
        <section id="uploading-data" className="bg-white rounded-xl shadow-lg border border-[#cfd592] p-4 sm:p-6 lg:p-8 mb-6 sm:mb-8">
          <h2 className="text-xl sm:text-2xl lg:text-3xl font-semibold text-[#494f25] mb-4 sm:mb-6">Uploading Your Data</h2>
          
          <div className="mb-4 sm:mb-6">
            <h3 className="text-lg sm:text-xl font-semibold text-[#596229] mb-2 sm:mb-3">Step 1: Access the Upload Page</h3>
            <ul className="list-disc list-inside space-y-1 sm:space-y-2 text-sm sm:text-base text-gray-700 pl-2">
          ...
          <div className="mb-4 sm:mb-6">
            <h3 className="text-lg sm:text-xl font-semibold text-[#596229] mb-2 sm:mb-3">Step 2: Choose Your File</h3>
            <div className="mb-3 sm:mb-4">
              <h4 className="text-base sm:text-lg font-medium text-gray-700 mb-2">Option A: Drag and Drop</h4>
            ...
            <div className="mb-3 sm:mb-4">
              <h4 className="text-base sm:text-lg font-medium text-gray-700 mb-2">Option B: Click to Browse</h4>
              <ul className="list-disc list-inside space-y-1 text-sm sm:text-base text-gray-700 ml-2 sm:ml-4">
          ...
          <div className="mb-4 sm:mb-6">
            <h3 className="text-lg sm:text-xl font-semibold text-[#596229] mb-2 sm:mb-3">Step 3: AI Processing</h3>
            <ul className="list-disc list-inside space-y-1 sm:space-y-2 text-sm sm:text-base text-gray-700 pl-2">
          ...
          <div className="mb-4 sm:mb-6">
            <h3 className="text-lg sm:text-xl font-semibold text-[#596229] mb-2 sm:mb-3">Supported File Types</h3>
          ...
          <div className="bg-[#f9f9ec] border-l-4 border-[#96a141] p-3 sm:p-4 rounded-r-lg">
            <h3 className="text-base sm:text-lg font-semibold text-[#494f25] mb-2">File Size Limits</h3>
            <ul className="list-disc list-inside space-y-1 text-sm sm:text-base text-[#596229] pl-2">
        ...
        <section id="viewing-data" className="bg-white rounded-xl shadow-lg border border-[#cfd592] p-4 sm:p-6 lg:p-8 mb-6 sm:mb-8">
          <h2 className="text-xl sm:text-2xl lg:text-3xl font-semibold text-[#494f25] mb-4 sm:mb-6">Viewing Your Data</h2>
          
          <div className="mb-4 sm:mb-6">
            <h3 className="text-lg sm:text-xl font-semibold text-[#596229] mb-2 sm:mb-3">The Data Viewer</h3>
            <p className="text-sm sm:text-base text-gray-700 mb-3 sm:mb-4">After uploading, you&apos;ll see your data in a spreadsheet-like view:</p>
            
            <h4 className="text-base sm:text-lg font-medium text-[#596229] mb-2 sm:mb-3">Understanding the Layout</h4>
            <ul className="list-disc list-inside space-y-1 sm:space-y-2 text-sm sm:text-base text-gray-700 pl-2">
          ...
          <div className="mb-4 sm:mb-6">
            <h3 className="text-lg sm:text-xl font-semibold text-[#596229] mb-2 sm:mb-3">Key Features</h3>
            <ul className="list-disc list-inside space-y-1 sm:space-y-2 text-sm sm:text-base text-gray-700 pl-2">
          ...
          <div className="bg-[#f9f9ec] border-l-4 border-[#96a141] p-3 sm:p-4 rounded-r-lg">
            <h3 className="text-base sm:text-lg font-semibold text-[#494f25] mb-2">Navigation Tips</h3>
            <ul className="list-disc list-inside space-y-1 text-sm sm:text-base text-[#596229] pl-2">
